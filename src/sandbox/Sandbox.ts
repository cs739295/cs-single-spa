...
import { Application, MicroWindow } from 'src/types'
import { isFunction } from 'src/utils'
import deepCopy from 'src/utils/deeoCopy'
...
import { temporarySetCurrentAppName } from 'src/utils/application'
...
export class Sandbox {
    ...
    hijackProperties() {
        ...
        microAppWindow.setInterval = function setInterval(
            ...
            const timer = originalWindow.setInterval(
                callback,
                timeout,
                ...args,
            )
        ...
        microAppWindow.clearTimeout = function clearTimeout(
            timer?: number,
        ): void {
            if (timer === undefined) return
            originalWindow.clearTimeout(timer)
